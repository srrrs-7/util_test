...
const file_chat_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"chat.proto\x12\x04Chat\x1a\x1fgoogle/protobuf/timestamp.proto\"z\n" +
	"\aMessage\x12\x0e\n" +
...
var file_chat_proto_depIdxs = []int32{
	1, // 0: Chat.Message.created_at:type_name -> google.protobuf.Timestamp
	0, // 1: Chat.ChatService.Chat:input_type -> Chat.Message
